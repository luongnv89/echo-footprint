...
- **Trust Through Transparency:** Reinforce privacy assurances via inline messaging, transparency cues, and data provenance labels.
...
| **Confusing privacy messaging** | Users distrust extension, uninstall | Repeat “Local-only” messaging in empty states/tooltips, provide clear privacy statement, include privacy badge next to CTAs |
