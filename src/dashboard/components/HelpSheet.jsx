      ...
      >
        ...
        <div className="sheet-body help-content">
          <section
            ...
            aria-hidden={activeTab !== 'getting-started'}
          >
            <h3>Welcome to EchoFootPrint</h3>
            <p>
              EchoFootPrint helps you visualize how you're being tracked across
              the web by 50 major ad networks including Facebook, Google, The
              Trade Desk, Criteo, Taboola, LinkedIn, TikTok, Amazon, Unity Ads,
              and many more.
            </p>
            ...
            <ol className="help-list">
              <li>
                <strong>Browse Normally</strong> - EchoFootPrint works silently
                in the background. No configuration needed.
              </li>
              <li>
                <strong>Automatic Detection</strong> - When you visit websites,
                we detect tracking pixels from 50 major ad network platforms.
              </li>
              <li>
          ...
          >
            ...
            <div className="feature-item">
              ...
              <p>
                We detect tracking pixels from {platformNames.length} platforms
                across social, exchanges, DSPs/SSPs, content discovery, mobile,
            ...
            <div className="feature-item">
              <h4>Export</h4>
              <p>
                Use the <strong>Export CSV</strong> button in the Data Table to
                download your data. Visual exports are currently disabled.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <div className="faq-item">
              ...
              <p>
                ...
                collect information about your browsing activity and send it to
                advertising platforms. They're used for targeted advertising,
            ...
            <div className="faq-item">
              ...
              <p>
                ...
                goal is to make tracking visible and transparent. If you want to
                block trackers, consider using extensions like uBlock Origin or
                Privacy Badger.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                ...
                using IndexedDB. We don't send any data to external servers. No
                telemetry, no cloud sync, no tracking.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                ...
                example, "snap.linkedin.com" shows as "linkedin.com". Hover over
                nodes or check the Data Table to see full domain names.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                ...
                version and a short description of what you were doing when the
                issue occurred.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                No. All detections are stored locally in your browser. We do not
                transmit data to any servers, and there is no telemetry or
                analytics.
              </p>
            </div>
          </section>
